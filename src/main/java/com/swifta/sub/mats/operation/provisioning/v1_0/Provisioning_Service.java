 ...
 * 2014-11-11T14:05:46.957+01:00
 * Generated source version: 3.0.2
 * 
 */
@WebServiceClient(name = "provisioning", 
                  wsdlLocation = "/Users/user/Documents/swifta/provisions/provisioning/Provisioning-2.wsdl",
...
public class Provisioning_Service extends Service {
    ...
    static {
        URL url = Provisioning_Service.class.getResource("/Users/user/Documents/swifta/provisions/provisioning/Provisioning-2.wsdl");
        if (url == null) {
            url = Provisioning_Service.class.getClassLoader().getResource("/Users/user/Documents/swifta/provisions/provisioning/Provisioning-2.wsdl");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(Provisioning_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "/Users/user/Documents/swifta/provisions/provisioning/Provisioning-2.wsdl");
        }       
        WSDL_LOCATION = url;
    }
