 ...
 * 2014-12-01T13:58:01.139+01:00
 * Generated source version: 3.0.2
 * 
 */
@WebServiceClient(name = "provisioning", 
                  wsdlLocation = "/Users/user/git/Provisioning/src/main/webapp/WEB-INF/wsdl/Provisioning.wsdl",
...
public class Provisioning_Service extends Service {
    ...
    static {
        URL url = Provisioning_Service.class.getResource("/Users/user/git/Provisioning/src/main/webapp/WEB-INF/wsdl/Provisioning.wsdl");
        if (url == null) {
            url = Provisioning_Service.class.getClassLoader().getResource("/Users/user/git/Provisioning/src/main/webapp/WEB-INF/wsdl/Provisioning.wsdl");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(Provisioning_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "/Users/user/git/Provisioning/src/main/webapp/WEB-INF/wsdl/Provisioning.wsdl");
        }       
        WSDL_LOCATION = url;
    }
