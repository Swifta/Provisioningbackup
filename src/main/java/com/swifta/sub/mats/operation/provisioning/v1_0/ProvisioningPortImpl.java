...
/**
 * This class was generated by Apache CXF 3.0.2 2014-12-01T13:58:01+01:00
...
public class ProvisioningPortImpl implements Provisioning {
	...
	public com.swifta.sub.mats.operation.provisioning.v1.Servicefeeandcomissionrequestresponse setupservicefeesandcommission(
		...
		try {
			return accountHolderService.setupservicefeesandcommission(
	...
	public com.swifta.sub.mats.operation.provisioning.v1.Registrationrequestresponse registration(
		...
		try {
			return accountHolderService.registration(username, msisdn, email,
					profileid, bankcodeid, bankaccount, clearingnumber,
	...
	public com.swifta.sub.mats.operation.provisioning.v1.SetDefaultaccountrequestresponse setdefaultaccount(
		...
		try {
			return accountHolderService.setdefaultaccount(userresourceid,
					paraentaccountresourceid, reason);
		} catch (java.lang.Exception ex) {
			ex.printStackTrace();
			throw new RuntimeException(ex);
		}
	...
	public com.swifta.sub.mats.operation.provisioning.v1.Setparentrequestresponse setparentaccount(
		...
		System.out.println(reason);
		try {
			return accountHolderService.setparentaccount(userresourceid,
					paraentaccountresourceid, reason);
		} catch (java.lang.Exception ex) {
			ex.printStackTrace();
			throw new RuntimeException(ex);
	...
	public com.swifta.sub.mats.operation.provisioning.v1.Linkaccountresponse linkaccountrequest(
		...
		System.out.println(reason);
		try {
			return accountHolderService.linkaccountrequest(userresourceid,
					profileid, paraentaccountresourceid, reason);
		} catch (java.lang.Exception ex) {
			ex.printStackTrace();
			throw new RuntimeException(ex);
		}
	...
	public com.swifta.sub.mats.operation.provisioning.v1.Activationresponse activationrequest(
		...
		System.out.println(currency);
		try {
			return accountHolderService.activationrequest(resourceid,
					credential, securityquestionanswer, identificationno,
