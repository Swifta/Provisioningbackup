 ...
 * Generated source version: 3.0.1 /home/ec2-user/wsdl/Provisioning.wsdl
 * 
 * 
 */
...
public class ProvisioningPortImpl implements Provisioning {
	...
	public com.swifta.sub.mats.operation.provisioning.v1.Linkaccountresponse linkaccountrequest(
		...
		try {
			com.swifta.sub.mats.operation.provisioning.v1.Linkaccountresponse _return = null;
			return _return;
		} catch (java.lang.Exception ex) {
			ex.printStackTrace();
			throw new RuntimeException(ex);
	...
	public com.swifta.sub.mats.operation.provisioning.v1.SetDefaultaccountrequestresponse setdefaultaccount(
		...
		System.out.println(reason);
		try {
			com.swifta.sub.mats.operation.provisioning.v1.SetDefaultaccountrequestresponse _return = null;
			return _return;
		} catch (java.lang.Exception ex) {
			ex.printStackTrace();
			throw new RuntimeException(ex);
