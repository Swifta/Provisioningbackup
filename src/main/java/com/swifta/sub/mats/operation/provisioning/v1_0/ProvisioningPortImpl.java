...
/**
 * This class was generated by Apache CXF 3.0.2 2014-11-11T22:57:47.477+01:00
...
public class ProvisioningPortImpl implements Provisioning {
	...
	public com.swifta.sub.mats.operation.provisioning.v1.Registrationrequestresponse registration(
		...
		try {
			int currencyidint = Integer.parseInt(currencyid);
			int bankdomainid = Integer.parseInt(bankdomainnameid);
			...
			requestResponse.setResponsemessage(accountHolderService
					.registerUser(accountholderdetails, bankaccount,
							...
							currencyidint, email, msisdn, profileid,
	 ...
	 * 
	 * @see com.swifta.sub.mats.operation.provisioning.v1_0.Provisioning#
	 * addloginCounttouserprofile(java.lang.String profile ,)java.lang.String
	...
	public com.swifta.sub.mats.operation.provisioning.v1.Operationresponse addloginCounttouserprofile(
			...
			java.lang.String limitmessage,
			com.swifta.sub.mats.operation.provisioning.v1.ParameterExtension extensionparameters) {
		LOG.info("Executing operation addloginCounttouserprofile");
		System.out.println(profile);
		System.out.println(countername);
		System.out.println(description);
		System.out.println(limit);
